# Generated by Django 3.1.2 on 2020-12-09 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employer_logo', models.ImageField(blank=True, null=True, upload_to='photos')),
            ],
        ),
        migrations.CreateModel(
            name='Employer_Size',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_wage_range', models.CharField(choices=[('state minimum hourly wage', 'State Minimum Hourly Wage'), ('<10k', 'Less than 10K Yearly'), ('10-19k yearly', '10-19K Yearly'), ('20k-39k yearly', '20k-39K Yearly'), ('40k-64k yearly', '40k-64K Yearly'), ('65k-70k yearly', '65k-69K Yearly'), ('70-99k yearly', '70-99K Yearly'), ('100k+', '100K+'), ('undisclosed', 'Undisclosed')], default='state minimum hourly wage', max_length=50)),
                ...
                ('employer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employer', to='listings.employer')),
            ],
        ),
        migrations.CreateModel(
            name='Job_Type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.job_listing')),
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.skill')),
            ],
        ),
        migrations.AddField(
