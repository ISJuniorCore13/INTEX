# Generated by Django 3.1.2 on 2020-12-06 01:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_lvl', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.education')),
                ('minority_status', models.ManyToManyField(to='listings.Minority_Type')),
            ],
        ),
        migrations.CreateModel(
            name='User_Skill',
        ...
        migrations.AddField(
            ...
            name='job_type_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.job_type'),
        ),
        migrations.CreateModel(
            name='Employer',
            fields=[
                ...
                ('size_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.employer_size')),
            ],
        ),
        migrations.CreateModel(
            name='Application',
